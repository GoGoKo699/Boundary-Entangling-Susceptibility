...
An independently written archived-row estimator reconstructs all 16 finite-size coefficients from 237,600 state records. The seed replication repeats the simulation campaign but is not an independently developed simulator or an external replication.
